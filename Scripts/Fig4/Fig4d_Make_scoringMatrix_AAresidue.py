...
AA_residue_d = pickle.load(open('/Users/georg.michlits/Desktop/Gen_properties/' + Species + '/property_sav/AA_residue_d.sav', 'rb'))
...
score_matrix_output = open(Species + '_AAlist_out.txt','w')
...
for Screen_data_name in Screen_data_namelist:
    ...
    for gene in best_worst:
        ...
        if best_pos in AA_residue_d and worst_pos in AA_residue_d:
