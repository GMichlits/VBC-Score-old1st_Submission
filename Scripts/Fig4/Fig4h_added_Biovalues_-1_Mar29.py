...
Species = 'Hm'
Output_name = 'Bioscore-1_Brunello_v3'
...
x_name = ['blank','Phylo7','Phast7','Pfam','others','AA_7','AA_type','combo']
for x in x_name:
    ...
    for data_set in IMP_3_screens:
        for pos in data_set:
            if pos in phylo_d and pos in AA_type_cut:
                if pos in AA_d:
    ...
    c_list_feat = ['k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k']
...
y_err = []
['blank','Phylo7','Phast7','Pfam','others','AA_7','AA_type','combo','random']
c_list = ['b','b','b','b','b','b','b','b']
variable = 'Bioscore-1_V3_Nov'
