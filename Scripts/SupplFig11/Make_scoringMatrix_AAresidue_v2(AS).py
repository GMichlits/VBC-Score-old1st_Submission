...
score_matrix_output = open(Species + '_AAlist_outp2(AS).txt','w')
...
for Screen_data_name in Screen_data_namelist:
    ...
    for pos in Screen_data_rel:
        ...
        if pos in Gene_direction_d:
            ...
            if pos in AA_residue_d and not guide_orient == gene_orient:
                AA = AA_residue_d[pos]
    ...
    for gene in best_worst:
        ...
        if best_pos in Gene_direction_d:
            ...
            if best_pos in AA_residue_d and not guide_orient == gene_orient:
        ...
        if worst_pos in Gene_direction_d:
            ...
            if worst_pos in AA_residue_d and not guide_orient == gene_orient:
