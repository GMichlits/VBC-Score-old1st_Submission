...
import pickle
Gene_to_20nt_to_pos = pickle.load(open('/Users/georg.michlits/Desktop/Gen_properties/Ms/property_sav/Gene_to_20nt_to_pos.sav', 'rb'))
AA_cons_d = pickle.load(open('/Users/georg.michlits/Desktop/Gen_properties/Ms/property_sav/AA_cons_d.sav', 'rb'))


Ms_cons = open('Msgene_conservation.txt','r')
GO_descr = open('goTermsDescription.txt','r')
gene_Go = open('gene_association.mgi.txt','r')
CEG2_gene_set = open('CEG2_mouse.txt','r')
outfile = open('AAcons_vs_mean_std_within.txt','w')
...
outfile.write('GO_ID\tGO_term\tGO_class\tn_genes\tmean_cons\twithin_gene_AA_std\tstd_cons\tsem_cons\tgenelist_max100')
count_goterms = 0
