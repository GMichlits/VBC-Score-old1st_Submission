...
print('load phylo')
phast_d = pickle.load(open('/Users/georg.michlits/Desktop/Gen_properties/'+Species+'/property_sav/phylo_v2_d.sav', 'rb'))
#print('load phast')
...
x_name = ['blank','P_1','P_3','P_5','P_7','P_9','P_1+3+5+7+9', 'random']
for x in x_name:
        ...
        if True: #pos in phylo_d:
            if pos in phast_d:
                if True:# pos in inDelphi_infr_d:
                    ...
                    i_training += 1
                    #PHYLO
                    ['blank','P_1','P_3','P_5','P_7','P_9','P_1+3+5+7+9', 'random']
                    if x == 'P_1':
                        score = phast_d[pos][1]
                    ...
                    if x == 'P_9':
                        ...
                        data_list.append(score)
                    if x == 'P_1+3+5+7+9':
                        score = np.mean([phast_d[pos][1],phast_d[pos][3],phast_d[pos][5],phast_d[pos][7],phast_d[pos][9]])
                        data_list.append(score)
                    if x == 'random':
    ...
    Feature_name_list = []
    if x == 'P_1':
        Feature_name_list.append('P1')
    if x == 'P_3':
        Feature_name_list.append('P3')
    if x == 'P_5':
        Feature_name_list.append('P5')
    if x == 'P_7':
        Feature_name_list.append('P7')
    if x == 'P_9':
        Feature_name_list.append('P9')
    if x == 'P_1+3+5+7+9':
        Feature_name_list.append('P1+3+5+7+9')
    if x == 'random':
...
y_mean = []
y_err = []
c_list = ['m','m','m','m','m','m','grey','k','k','k','k']
variable = 'Phylo_KBM7'
