...
Output_name = Species + '_make_Apr1_VBC_score_' + model_input.split('.')[0] + '_vx2'
...
print('load model')
model_VBCscore = pickle.load(open('/Users/georg.michlits/Desktop/Models/VBC_score/Apr1model_' + model_input,'rb'))
...
for pos in VBC_crude_score_d:
    ...
    #if VBC_scaled > 0.3:
    #    VBC_scaledv2 = (VBC_scaled-0.3)/0.7*0.9+0.1
    #else:
    #    VBC_scaledv2 = (VBC_scaled)/0.3*0.1
...
pickle.dump(VBC_score_d, open(Species + '_Apr1_VBC_score_' + model_input.split('.')[0] +'raw_d.sav','wb'))
