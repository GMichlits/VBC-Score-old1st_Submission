...
Species = 'Hm'
Output_name = 'BioD16inDel_Brunello_indiv_Apr1_v2'
...
x_name = ['sgRNA','inDelphi','Bioscore','VBC','random']
IMP_3_screens = [data_abs_1]#, data_abs_2, data_abs_3]
IMP_3_screens_names = ['KBM7','RKO','MIAPACA2']
run_n = -1
for data_set in IMP_3_screens:
    ...
    for x in x_name:
        ...
        #target_valid = []
        for pos in data_set:
            if pos in Bioscore_d and CN_d[pos] == 1:
                        data_list = []
                        ...
                        i_training += 1
                        #PHYLO
                        ['sgRNA','inDelphi','Bioscore','VBC','random']
                        if x == 'sgRNA':
        ...
        print(str(guide_not_found) + ' guides skipped')
        Feature_name_list = []
        ['sgRNA','inDelphi','Bioscore','VBC','random']
        if x == 'sgRNA':
    ...
    data_name = IMP_3_screens_names[run_n]
